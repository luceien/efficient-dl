...
def main():
    ...
    model = resnet20()#resnet.ResNet18()
    #model = ResNet18()#resnet.ResNet18()
    #path_model = 'Models/Accuracy_90/SGD_pruned_epochs_400_acc94.17.pth'
    #path_model = 'Models/Accuracy_90/SGD_pruned90_epochs_218_acc91.39.pth'
